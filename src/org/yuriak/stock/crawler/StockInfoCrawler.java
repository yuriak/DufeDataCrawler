package org.yuriak.stock.crawler;
...
import org.yuriak.stock.util.StockCommonUtil;
import org.yuriak.stock.util.StockTimeUtil;
...
public class StockInfoCrawler extends DeepCrawler {
	...
	public Links visitAndGetNextLinks(Page page) {
		if (!page.getUrl().equals("http://doctor.10jqka.com.cn/client.html")&&!page.getDoc().title().trim().equals("牛叉诊股-个股分析利器_同花顺金融网")) {
			...
			stock.setAdvice(advice==null?-1:StockCommonUtil.convertAdviceWord2Number(advice));
			...
			stock.setDate(date==null?new Date(System.currentTimeMillis()):StockTimeUtil.convertStringDateToDate(date,true));
